...
#jd_text=""
def calculate_resume_match_percentage(resume_file,jd_text):
    # Extract text from the resume and job description files
    # Create a list of the resume and job description
    if(len(jd_text)==0):
        return ""
    
    test = [resume_file, jd_text]
    
    # Create a CountVectorizer and transform the text
    cv = CountVectorizer()
...
st.set_page_config(
    page_title="Smart Resume Match",
    #page_icon='./Logo/SRA_Logo.ico',
)


def run():
    st.title("Smart Resume Match")
    st.sidebar.markdown("# Choose User")
    activities = ["Normal User", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    # st.sidebar.markdown(link, unsafe_allow_html=True)
    img = Image.open('./Logo/SMR.png')
    ...
    if choice == 'Normal User':
        ...
        jdf_file=st.text_input("Submit your Job Description")
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                t=calculate_resume_match_percentage(resume_text,jdf_file)
                st.subheader('** Your Resume x Job Description Match Score is: ' + t + '**')
